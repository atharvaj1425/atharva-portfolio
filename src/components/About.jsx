...
const About = () => {
  return (
    <>
      ...
      >
      A passionate software developer with expertise in full-stack development, AI, and machine learning, specializing in building intelligent, data-driven applications using Python, Django, and the MERN stack (MongoDB, Express.js, React, Node.js). I enjoy solving complex problems, learning new tools, and creating impactful solutions that enhance user experiences.
      </motion.p>

      <div className="flex gap-3 my-4 items-center">
      <a
    href="https://github.com/atharvaj1425"
    target="_blank"
  ...
  <a
    href="https://www.linkedin.com/in/atharva-jamdade-061350278/"
    target="_blank"
    className="w-8 h-8 hover:-translate-y-2 ease-in transition-all duration-100 cursor-pointer"
  >
  ...
  <a
    href="https://www.instagram.com/atharva_jammie14_/"
    target="_blank"
    className="w-8 h-8 hover:-translate-y-2 ease-in transition-all duration-100 cursor-pointer"
  >
...
<button className="shimmer-btn font-semibold" onClick={() => window.open('https://drive.google.com/file/d/1DCyuyD3LIkjD8KEHSgx3NXl-Hg6XJGsk/view?usp=sharing', '_blank')}>
